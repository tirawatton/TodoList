...
class LoggedInViewController: UIViewController {
    ...
    private func loggedInSuccessfully() {
    ...
    private func isLoggedInSuccessfull() {
        ...
        let tabBarViewController = TodoListViewController.instantiate()
        mainViewController.viewControllers = [tabBarViewController]

        dismiss(animated: true) {
//            UserDefaults.standard.setIsWelcomeAtFirstTime(set: true)
        }
    }
}
